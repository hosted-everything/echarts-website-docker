...
**[中文官网](/echarts-website/zh/index.html)** | **[ENGLISH HOMEPAGE](https://echarts.apache.org/en/index.html)**
...
+ Download from the [official website](/echarts-website/download.html)
+ `npm install echarts --save`
+ CDN: [jsDelivr CDN](https://www.jsdelivr.com/package/npm/echarts?path=dist)

## Docs

+ [Get Started](/echarts-website/handbook)
+ [API](/echarts-website/api.html)
+ [Option Manual](/echarts-website/option.html)
+ [Examples](/echarts-website/examples)
...
+ Subscribe to the [mailing list](/echarts-website/en/maillist.html) to get updated with the project
...
More custom build approaches can be checked in this tutorial: [Create Custom Build of ECharts](/echarts-website/en/tutorial.html#Create%20Custom%20Build%20of%20ECharts) please.
